...
void prog(int fd){
  char local_buf[1000];//yoooo, this is long 1000 dec but I'm reading 0x1000 hex, there is a clear overflow
...
int main()
{
    ...
    //This is actually IP 0.0.0.0 and it means that the socket will be listening on all interfaces.
