...
def genRandLong():
  ...
  iVar1 = index
  index = iVar1 + 1
  #LShR = Arithmetic Shift Right Long, here it is a Logical Shift Right(What_I_Shift, How_Many_Bites_I_Shift)
...
# to see claripy
seed = claripy.BVS("seed", 32)#This is a 32 BitVector SYMBOL !!!
